...
for (let nftCount = 0; nftCount < 200; nftCount++){
    ...
    let nft5 = document.createElement("img")
    ...
    nft5.style.filter = `drop-shadow(0 100px ${getRandomColor()})`
    ...
    nft5.src = `img/acs/acs-${getRandomNumberInRange(1, 15)}.png`
    ...
    nft5.classList.add("image-parts")
